  ...
  <div class="app-container">
      ...
      <div style="margin-top:15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="申请时间：">
            <el-date-picker v-model="listQuery.createTime" class="input-width" placeholder="请选择时间" value-format="yyyy-MM-dd" type="date">
            </el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="处理时间：">
            <el-date-picker v-model="listQuery.handleTime" class="input-width" placeholder="请选择时间" value-format="yyyy-MM-dd" type="date">
            </el-date-picker>
          </el-form-item>
        </el-form>
      </div>
    ...
    <el-card calss="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="服务编号" width="180" align="center">
        ...
        <el-table-column label="操作" width="180" align="center">
         <template slot-scope="scope">
          <el-button type="mini" @click="handleViewDetail(scope.$index, scope.row)">查看详情</el-button>
         </template>
        </el-table-column>
      </el-table>
    </el-card>
    <div class="batch-operate-container">
      <el-select size="small" v-model="operateType" placeholder="批量删除">
...
export default {
    ...
    filters: {
      ...
      formatReturnAmount(row) {
        return row.productRealPrice*row.productCount;//产品实际价格* 产品数
      }
    },
    methods: {
