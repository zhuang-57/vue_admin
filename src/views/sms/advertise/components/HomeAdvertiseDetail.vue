  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="homeAdvertise"
        ...
        <el-form-item label="开始时间：" prop="startTime">
            <el-date-picker type="datetime" v-model="homeAdvertise.startTime" placeholder="选择日期"></el-date-picker>
        </el-form-item>
        <el-form-item label="到期时间：" prop="endTime">
            <el-date-picker type="datetime" v-model="homeAdvertise.endTime" placeholder="选择日期"></el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="广告备注：">
            <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="homeAdvertise.note" class="input-width"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    return {
        ...
        rules: {
            name: [
                ...
                {min: 2, max: 140, message: '长度在2 到 140个字符之间', trigger: 'blur'}
            ],
            url: [
