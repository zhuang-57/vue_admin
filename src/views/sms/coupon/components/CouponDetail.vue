    ...
    <el-card class="form-container" shadow="never">
        <el-form
            ...
            <el-form-item label="总发行量：" prop="publishCount">
                <el-input v-model.number="coupon.publishCount" class="input-width" placeholder="只能输入正整数"></el-input>
            </el-form-item>
            <el-form-item label="面额：" prop="amount">
                <el-input v-model.number="coupon.amount" class="input-width" placeholder="面值只能是数值，限2位小数">
                    <template slot="append">元</template>
                </el-input>
            </el-form-item>
            <el-form-item label="每人限领：">
                <el-input v-model="coupon.perLimit" class="input-width" placeholder="只能输入正整数">
                    <template slot="append">张</template>
                </el-input>
            </el-form-item>
            <el-form-item label="使用门槛：" prop="minPoint">
                <el-input v-model.number="coupon.minPoint" class="input-width" placeholder="只能输入正整数">
                    <template slot="prepend">满</template>
                    <template slot="append">元可用</template>
                </el-input>
            </el-form-item>
            <el-form-item label="领取日期：" prop="enableTime">
                <el-date-picker type="date" v-model="coupon.enableTime" class="input-width" placeholder="选择日期">
                </el-date-picker>
            </el-form-item>
            <el-form-item label="有效期：">
                <el-date-picker type="date" v-model="coupon.startTime" style="width: 150px" placeholder="选择日期"></el-date-picker>
                <span style="margin-left: 20px; margin-right:20px">至</span>
                <el-date-picker type="date" v-model="coupon.endTime" style="width: 150px" placeholder="选择日期"></el-date-picker>
            </el-form-item>
                    ...
                    <el-table ref="productCateRelationTable"
                        ...
                        <el-table-column label="操作" width="100" align="center">
                            <template slot-scope="scope">
                                <el-button type="text" size="mini" @click="handleDeleteProductCateRelation(scope.$index, scope.row)">删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
            </el-form-item>
            ...
            <el-form-item label="备注：">
                <el-input v-model="coupon.note" class="input-width" type="textarea" :rows="5" placeholder="请输入内容"></el-input>
            </el-form-item>
            <el-form-item>
