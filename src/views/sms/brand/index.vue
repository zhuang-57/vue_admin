      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="状态推荐：">
            <el-select v-model="listQuery.recommendStatus" class="input-width" placeholder="全部" clearable>
    ...
    <div class="table-container">
      <el-table ref="homeBrandTable"
        ...
        <el-table-column label="操作" width="180" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="mini" @click="handleEditSort(scope.$index,scope.row)">设置排序</el-button>
