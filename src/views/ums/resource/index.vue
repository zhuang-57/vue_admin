<template>
  <div class="app-container">
      ...
      <div style="margin-top: 15px"> 
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="资源名称：">
            <el-input :model="listQuery.nameKeyword" class="input-width" placeholder="资源名称" clearable></el-input>
          </el-form-item>
          <el-form-item label="资源路径：">
            <el-input :model="listQuery.urlKeyword" class="input-width" placeholder="资源路径" clearable></el-input>
          </el-form-item>
          <el-form-item label="资源分类：">
            <el-select :model="listQuery.categoryId" class="input-width" placeholder="全部" clearable>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" @click="handleAdd()" class="btn-add" style="margin-left: 20px">添加</el-button>
      <el-button size="mini" @click="handleShowCategory()" class="btn-add">资源分类</el-button>
    </el-card>
    ...
    <el-dialog
       ...
       width="40%">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="handleDialogConfirm()" size="small">确定</el-button>
        </span>
    </el-dialog>
  </div>
</template>
    ...
    handleDialogConfirm() {
      this.$confirm('是否要确认？','提示', {
        ...
        if(this.isEdit) {
          ...
          createResource(this.resource.id, this.resource).then(response => {
            this.$message({
              message: '添加成功！',
              type: 'success'
            });
